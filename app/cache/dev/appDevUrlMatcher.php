        ...
        if (0 === strpos($pathinfo, '/a')) {
            if (0 === strpos($pathinfo, '/age')) {
                ...
                if (0 === strpos($pathinfo, '/age/calculate') && preg_match('#^/age/calculate(?:/(?P<dob>[^/]++))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'age_calc_calculate')), array (  '_controller' => 'Age\\CalcBundle\\Controller\\DefaultController::calculateAction',  'dob' => 0,));
                }
